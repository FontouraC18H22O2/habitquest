...
export default function Diet() {
  ...
  async function analyzeWithGemini(imageUri: string) {
    ...
    try {
      ...
      Alert.alert(
        "Erro",
        "Não foi possível analisar a imagem. Tenta novamente.",
      );
    }
    setAnalyzing(false);
  }
  ...
  const caloriesPercent = Math.min(
    (totalCalories / goal.daily_calories) * 100,
    100,
  );
      ...
      <View style={[styles.caloriesCard, { backgroundColor: colors.card }]}>
        <View style={styles.caloriesRow}>
          <View>
            ...
            <Text
              style={[styles.caloriesLabel, { color: colors.textSecondary }]}
            >
              {t("calories_consumed")}
            </Text>
          </View>
          <View
            style={[styles.caloriesDivider, { backgroundColor: colors.card2 }]}
          />
          <View>
            <Text style={[styles.caloriesValue, { color: colors.text }]}>
              {goal.daily_calories - totalCalories}
            </Text>
            <Text
              style={[styles.caloriesLabel, { color: colors.textSecondary }]}
            >
          ...
          <View
            style={[
              styles.caloriesBarFill,
              {
                ...
                backgroundColor:
                  caloriesPercent > 90 ? colors.danger : colors.success,
              },
            ]}
          />
        </View>
          ...
          >
            ...
            <View style={styles.mealInfo}>
              ...
              <Text style={[styles.mealType, { color: colors.textSecondary }]}>
                {MEAL_TYPES.find((mt) => mt.id === meal.meal_type)?.icon}{" "}
                {t(meal.meal_type)}
              </Text>
              <View style={styles.mealMacros}>
                <Text
                  style={[styles.mealMacroText, { color: colors.textMuted }]}
                >
                  P: {meal.protein}g
                </Text>
                <Text
        ...
        <View style={styles.modalOverlay}>
          ...
          >
            ...
            {aiResult && (
              ...
              >
                <Text style={[styles.aiResultTitle, { color: colors.primary }]}>
                  {t("ai_analysis")}
                </Text>
                <Text style={[styles.aiResultName, { color: colors.text }]}>
                  {aiResult.name}
                </Text>
                <View style={styles.aiMacros}>
                  {[
                    ...
                    <View key={item.label} style={styles.aiMacroItem}>
                      <Text
                        style={[styles.aiMacroValue, { color: colors.text }]}
                      >
                        {item.value}
                      </Text>
                      <Text
                ...
                <Text
                  style={[styles.aiDisclaimer, { color: colors.textMuted }]}
                >
                  {t("ai_disclaimer")}
                </Text>
              </View>
            ...
            <View style={styles.modalButtons}>
              ...
              <TouchableOpacity
                style={[
                  ...
                  {
                    backgroundColor: !aiResult ? colors.card2 : colors.primary,
                  },
                ]}
                onPress={saveMeal}
                disabled={!aiResult}
      ...
      <Modal visible={showGoalModal} transparent animationType="slide">
        <View style={styles.modalOverlay}>
          <View style={[styles.goalModal, { backgroundColor: colors.card }]}>
            ...
            {[
              ...
              <View key={field.key} style={styles.goalField}>
                ...
                <TextInput
                  ...
                  onChangeText={(v) =>
                    setGoalInputs((prev) => ({ ...prev, [field.key]: v }))
                  }
            ...
            <View
              style={[styles.modalButtons, { paddingBottom: insets.bottom }]}
            >
              <TouchableOpacity
                style={[
                  styles.modalCancelBtn,
