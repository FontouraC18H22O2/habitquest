    ...
    <View style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.badgesRow}>
          ...
          {completionsCount === 0 && (
            <Text style={styles.noBadges}>Completa hábitos para desbloquear conquistas!</Text>
          )}
        </View>
      </View>
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#0f0f1a', padding: 24, paddingTop: 56 },
  loading: { color: '#888', textAlign: 'center', marginTop: 40 },
  avatarSection: { alignItems: 'center', marginBottom: 32 },
  avatar: {
    width: 96, height: 96, borderRadius: 48,
    backgroundColor: '#1e1e2e', justifyContent: 'center',
  ...
  levelBadge: {
    backgroundColor: '#6c63ff33', borderRadius: 20,
  ...
  xpBar: { height: 10, backgroundColor: '#1e1e2e', borderRadius: 5, overflow: 'hidden' },
  ...
  badge: {
    ...
    padding: 16, alignItems: 'center', minWidth: 90,
  },
